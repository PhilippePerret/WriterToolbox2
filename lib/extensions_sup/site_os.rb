...
=begin
  ...
  Extension de la classe Site pour gérer l'operating system
  de l'user et notamment savoir s'il est sur windows ou sur Mac
  ou sur Unix.

  Utile par exemple dans le programme UN AN UN SCRIPT pour définir
  les paths que l'auteur doit utiliser.
