...
Dans ce test, un inscrit dépose un message qui sera détruit sans possibilité
de modifier son message.
...
feature "Forum : réponse à un message et DESTRUCTION ARGUMENTÉ par un administrateur" do
  before(:all) do
